...
<div class="max-w-10xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-4 sm:px-0">
        <div class="bg-white rounded-lg p-6">
            ...
            <section id="profil">
                <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg flex">
                    <!-- Profile Picture and Upload Button -->

                    <div class="mx-25 w-1/4 text-center">
                    ...
                    <div class="px-5 ml-7 inline-block h-[500px] min-h-[1em] w-0.5 self-stretch border-l-2 border-black-500 dark:bg-white/10"></div>
            ...
            <section id="notifikasi" class="hidden">
                <div class="max-w-4xl mx-auto mt-10 p-3 bg-white rounded-lg ">
