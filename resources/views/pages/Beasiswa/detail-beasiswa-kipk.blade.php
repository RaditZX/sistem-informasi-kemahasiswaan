...
@section('content')
    ...
    <div class="flex flex-col items-start justify-left ml-10 mr-10 gap-5 mt-5">
        <p class="font-normal text-sm text-black">
            Pemerintah Indonesia terus berkomitmen untuk fokus meningkatkan pembangunan Sumberdaya Manusia melalui berbagai
            upaya cerdas. Kartu Indonesia Pintar Kuliah (KIP-Kuliah)
            adalah salah satu upaya untuk membantu asa para siswa yang memiliki keterbatasan ekonomi tetapi berprestasi
            untuk melanjutkan studi di perguruan tinggi.
        </p>
        <p class="font-normal text-sm text-black">
            KIP-KULIAH MERDEKA 2023 KIP Kuliah Merdeka Tahun 2023 sudah dibuka! Ayo manfaatkan program KIP Kuliah Merdeka
            untuk meraih cita-citamu.
            Pendaftaran KIP Kuliah Merdeka memerlukan data Nomor Induk Siswa Nasional (NISN), Nomor Pokok Sekolah Nasional
            (NPSN), dan Nomor Induk Kependudukan (NIK).
            Pastikan NISN, NPSN dan NIK dari calon peserta KIP Kuliah 2023 valid, sesuai data yang tercatat di Data Pokok
            Pendidikan (Dapodik), Kemendikbudristek.
        </p>
        <p class="font-normal text-sm text-black">
            Pastikan NISN, NPSN dan NIK dari calon peserta KIP Kuliah 2023 valid, sesuai data yang tercatat di Data Pokok
            Pendidikan (Dapodik), Kemendikbudristek.
