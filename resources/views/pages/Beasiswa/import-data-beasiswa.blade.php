...
@section('content')
    ...
    <!-- Alert Popup -->
    <div id="alertPopup" class="fixed top-4 right-4 z-50 hidden w-80 bg-white shadow-lg rounded-lg border border-gray-200 flex items-center p-4 transition-all duration-300 ease-in-out">
    ...
    <script>
        ...
        function showAlert(type, title, message) {
            ...
            alertPopup.className = 'fixed top-4 right-4 z-50 w-80 bg-white shadow-lg rounded-lg border flex items-center p-4 transition-all duration-300 ease-in-out';
