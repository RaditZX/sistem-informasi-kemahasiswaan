...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 p-5">
        ...
        <div class="p-2">
            ...
            <p class="text-xs text-justify mb-2">"{{$ba->deskripsi}}Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsam nobis omnis, quaerat aliquam magni laborum repellat libero fuga. Numquam dolore consequatur perspiciatis dolor pariatur est assumenda sapiente aliquam, fugiat doloremque."</p>
