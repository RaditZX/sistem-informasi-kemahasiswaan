                        ...
                        <div id="group-{{ $index }}" class="group">
                            ...
                            <div class="hidden" id="upload-section-{{ $index }}">
                                <div class="border-t-0 border border-gray-400 p-4 mx-6 mt-0 text-center">
                                    ...
                                    <input id="file-upload-{{ $index }}" name="file_{{ $index }}" type="file" accept=".pdf" class="hidden"
                                        onchange="uploadFile({{ $index }})">
                                </div>
                            </div>

                            <!-- Display Uploaded File -->
                            <div class=" flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-{{ $index }}">
                                ...
                                <p class="text-gray-700" id="file-name-display-{{ $index }}">
                                    {{ $dokumen_pengajauan[ $index - 1]->nama_dokumen }}</p>

                                <div onclick="viewFile({{ $index }})" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                                ...
                                <div id="pdf-viewer-{{ $index }}"
                                    ...
                                    <div
                                        ...
                                        <!-- Close Button -->
                                        <div onclick="closePdfViewer({{ $index }})" class="absolute top-2 right-2 text-gray-600">
                ...
                @foreach ($dokumen as $item)
                    ...
                    <div class="group mb-5">
                        <div class="flex items-center border p-4 bg-white rounded-lg drop-shadow-lg relative cursor-pointer"
                            ...
                            <img src="data:image/png;base64,"
                                class="h-6 w-6 mr-4" alt="Upload Icon" />
                            <p class="text-gray-700">{{ $item->dokumen }} (KTM)</p>
                        </div>
                        ...
                        <!-- Display Uploaded File -->
                        <div class="hidden flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-{{ $index }}">
                            <img src="data:image/png;base64,"
                                class="h-6 w-6 mr-4" alt="Upload Icon" />
                            <p class="text-gray-700" id="file-name-display-{{ $index }}">Nama file</p>

                            <button onclick="viewFile({{ $index }})" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                                <img src="data:image/png;base64,"
                                    alt="View PDF" class="h-6 w-6" />
                            ...
                            <!-- Delete Button -->
                            <button onclick="deleteFile({{ $index }})" class="ml-4 p-2 text-red-500 hover:text-red-700">
                        ...
                        <div class="flex" id="progress-bar-container-{{ $index }}" style="display: none;">
                            <div class="progress-bar"
                                style="width: 100%; background-color: #f3f4f6; height: 10px; margin: 10px 6px;">
                                <div class="progress h-full bg-gradient-to-r from-blue-500 to-orange-500" id="progress-{{ $index }}"
