                            ...
                            <div class="hidden" id="upload-section-1">
                                <div class="border-t-0 border border-gray-400 p-4 mx-6 mt-0 text-center">
                                    ...
                                    <input id="file-upload-1" name="file_1" type="file" accept=".pdf"
                                        class="hidden" onchange="uploadFile(1)">
                                </div>
                            </div>

                            <!-- Display Uploaded File -->
                            <div class=" flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-1">
                                <img src="data:image/png;base64,"
                                    class="h-6 w-6 mr-4" alt="Upload Icon" />
                                <p class="text-gray-700" id="file-name-display-2">
                                    {{ $dokumen_pengajauan[0]->nama_dokumen }}</p>

                                <div onclick="viewFile(1)" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                            ...
                            <div class="hidden" id="upload-section-2">
                                <div class="border-t-0 border border-gray-400 p-4 mx-6 mt-0 text-center">
                                    ...
                                    <input id="file-upload-2" name="file_2" type="file" accept=".pdf"
                                        class="hidden" onchange="uploadFile(2)">
                                </div>
                            </div>

                            <!-- Display Uploaded File -->
                            <div class=" flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-2">
                                <img src="data:image/png;base64,"
                                    class="h-6 w-6 mr-4" alt="Upload Icon" />
                                <p class="text-gray-700" id="file-name-display-2">
                                    {{ $dokumen_pengajauan[1]->nama_dokumen }}</p>

                                <div onclick="viewFile(2)" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                                    <img src="data:image/png;base64,"
                                        alt="View PDF" class="h-6 w-6" />
                                    <span class="sr-only">View PDF 2</span>
                                </div>
                            ...
                            <div class="hidden" id="upload-section-3">
                                <div class="border-t-0 border border-gray-400 p-4 mx-6 mt-0 text-center">
                                    ...
                                    <input id="file-upload-3" name="file_3" type="file" accept=".pdf"
                                        class="hidden" onchange="uploadFile(3)">
                                </div>
                            </div>

                            <!-- Display Uploaded File -->
                            <div class=" flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-3">
                                <img src="data:image/png;base64,"
                                    class="h-6 w-6 mr-4" alt="Upload Icon" />
                                <p class="text-gray-700" id="file-name-display-3">
                                    {{ $dokumen_pengajauan[2]->nama_dokumen }}</p>

                                <div onclick="viewFile(3)" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                                    <img src="data:image/png;base64,"
                                        alt="View PDF" class="h-6 w-6" />
                            ...
                            <div class="hidden" id="upload-section-4">
                                <div class="border-t-0 border border-gray-400 p-4 mx-6 mt-0 text-center">
                                    ...
                                    <input id="file-upload-4" name="file_4" type="file" accept=".pdf"
                                        class="hidden" onchange="uploadFile(4)">
                                </div>
                            </div>

                            <!-- Display Uploaded File -->
                            <div class=" flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-4">
                                <img src="data:image/png;base64,"
                                    class="h-6 w-6 mr-4" alt="Upload Icon" />
                                <p class="text-gray-700" id="file-name-display-4">
                                    {{ $dokumen_pengajauan[3]->nama_dokumen }}</p>

                                <div onclick="viewFile(4)" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                                    <img src="data:image/png;base64,"
                                        alt="View PDF" class="h-6 w-6" />
                            ...
                            <div class="hidden" id="upload-section-5">
                                <div class="border-t-0 border border-gray-400 p-4 mx-6 mt-0 text-center">
                                    ...
                                    <input id="file-upload-5" name="file_5" type="file" accept=".pdf"
                                        class="hidden" onchange="uploadFile(5)">
                                </div>
                            </div>

                            <!-- Display Uploaded File -->
                            <div class=" flex items-center border p-4 bg-white drop-shadow-lg" id="file-display-5">
                                <img src="data:image/png;base64,"
                                    class="h-6 w-6 mr-4" alt="Upload Icon" />
                                <p class="text-gray-700" id="file-name-display-5">
                                    {{ $dokumen_pengajauan[4]->nama_dokumen }}</p>

                                <div onclick="viewFile(5)" class="ml-auto p-2 text-blue-500 hover:text-blue-700">
                                    <img src="data:image/png;base64,"
                                        alt="View PDF" class="h-6 w-6" />
            ...
            <form action="{{ route('pengajuan.store', ['id' => request()->route('id')]) }}" method="POST"
                ...
                <div class="group">
                    ...
                    <div class="flex" id="progress-bar-container-1" style="display: none;">
                        <div class="progress-bar"
                            style="width: 100%; background-color: #f3f4f6; height: 10px; margin: 10px 6px;">
                            <div class="progress h-full bg-gradient-to-r from-blue-500 to-orange-500" id="progress-1"
                ...
                <div class="group">
                    ...
                    <div class="flex" id="progress-bar-container-2" style="display: none;">
                        <div class="progress-bar"
                            style="width: 100%; background-color: #f3f4f6; height: 10px; margin: 10px 6px;">
                            <div class="progress h-full bg-gradient-to-r from-blue-500 to-orange-500" id="progress-2"
                                style="width: 0%; height: 100%; background-color: #3B3BBD; border-radius: 5px;"></div>
                        </div>
                    </div>
                ...
                <div class="group">
                    ...
                    <div class="flex" id="progress-bar-container-3" style="display: none;">
                        <div class="progress-bar"
                            style="width: 100%; background-color: #f3f4f6; height: 10px; margin: 10px 6px;">
                            <div class="progress h-full bg-gradient-to-r from-blue-500 to-orange-500" id="progress-3"
                                style="width: 0%; height: 100%; background-color: #3B3BBD; border-radius: 5px;"></div>
                        </div>
                    </div>
                ...
                <div class="group">
                    ...
                    <div class="flex" id="progress-bar-container-4" style="display: none;">
                        <div class="progress-bar"
                            style="width: 100%; background-color: #f3f4f6; height: 10px; margin: 10px 6px;">
                            <div class="progress h-full bg-gradient-to-r from-blue-500 to-orange-500" id="progress-4"
                                style="width: 0%; height: 100%; background-color: #3B3BBD; border-radius: 5px;"></div>
                        </div>
                    </div>
                ...
                <div class="group">
                    ...
                    <div class="flex" id="progress-bar-container-5" style="display: none;">
                        <div class="progress-bar"
                            style="width: 100%; background-color: #f3f4f6; height: 10px; margin: 10px 6px;">
                            <div class="progress h-full bg-gradient-to-r from-blue-500 to-orange-500" id="progress-5"
                                style="width: 0%; height: 100%; background-color: #3B3BBD; border-radius: 5px;"></div>
                        </div>
                    </div>
