...
@section('content')
    @include('component.navbar',['path'=>"Tracking Pengajuan",'id'=>null])
    
    <section class="timeline max-w-10xl mx-auto py-6 sm:px-6 lg:px-8">
        <ol class="items-center sm:flex">
            <li class="relative mb-6 sm:mb-0">
                ...
                <div class="mt-3 sm:pe-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-700">Submit</h3>
