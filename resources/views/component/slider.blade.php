...
.swiper-pagination-bullet {
    background: gray; /* Change bullet color */
...
.swiper-pagination-bullet-active {
    background: #FFCB25; /* Active bullet color */
}
      ...
      <div class="swiper-slide p-10 bg-white">
        <div class="rounded flex items-center bg-white-100 shadow-xl h-80 " >
          <div class="basis-1/4 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg">
            <img class=" w-full h-full object-cover object-center" src="https://th.bing.com/th/id/OIP.DmPQAB4t3Na-Xf7Vy2TGCQHaE8?rs=1&pid=ImgDetMain" alt="Image 1">
          </div>
          <div class="p-6 basis-3/4 ">
            <h2 class="text-xl font-bold">Penangungan UKT secara full</h2>
            <p class="mt-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aperiam sit reprehenderit perferendis dolorem architecto earum fugit et ad exercitationem autem itaque. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aperiam sit reprehenderit perferendis dolorem architecto earum fugit et ad exercitationem autem itaque</p>
          </div>
        </div>
      </div>
