...
class MaddingController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select(
            'poster_beasiswa.link_poster',  // Include poster link in the select
            'beasiswa.id',
        ...
        ->groupBy('beasiswa.id', 'beasiswa.nama_beasiswa', 'beasiswa.tanggal_mulai', 'poster_beasiswa.link_poster') // Include link_poster in the groupBy
        ...
        $newestMahasiswaAccepted = PenerimaBeasiswa::join('beasiswa', 'beasiswa.id', '=', 'penerima_beasiswa.beasiswa_id')
                                                    ...
                                                    ->orderByRaw('RANDOM()') // Randomize the order
                                                    ->take(12) // Limit to 12 results
                                                    ->paginate(4); // Paginate 4 per page
